...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 16 Oca 2023, 23:27:40
...
(9, 'Frutti Extra Bursaspor 111-93 Cedevita Olimpija', 'images/s22.jpeg', 'Basketbol 7Days Avrupa Kupası\'nın 10. haftasında A Grubu\'nda Frutti Extra Bursaspor, sahasında ağırladığı Slovenya\'nın Cedevita Olimpija takımını 111-93 yendi.\r\n\r\nMaça etkili başlayan Frutti Extra Bursaspor, Dudzinski, Onuralp Bitim ve Clemmons\'un yüksek yüzdeli atışlarıyla ilk çeyreği 30-15 önde bitirdi. İkinci çeyreğe iyi oyunla başlayan Cedevita Olimpija, Omic ve Ferrell\'den bulduğu sayılarla 16\'ncı dakikada skoru 40-34\'e getirerek, farkı 6\'ya indirdi. Seyircisinin desteğiyle maça yeniden ağırlığını koyan ev sahibi ekip, Onuralp Bitim ile Dudzinski\'nin etkili oyunuyla soyunma odasına 55-41 önde gitti.\r\nÜçüncü çeyrekte de etkili oyununu sürdüren Frutti Extra Bursaspor, 23\'üncü dakikada skoru 65-43\'e getirip, farkı 12 sayıya yükseltti. Sert savunmasıyla Cedevita Olimpija\'nın rahat skor üretmesine engel olan Frutti Extra Bursaspor, üçüncü çeyreği 80-64 önde tamamladı.\r\nSeyircinin desteğiyle son çeyrekte tempoyu arttıran Frutti Extra Bursaspor, dış atışlar ve boyalı alandan bulduğu yüksek yüzdeli atışlarla maçtan 111-93 galip ayrıldı.', 'FOTOMAÇ'),
(10, 'Türk gecesi! 14 takım mücadele edecek', 'images/s333.jpg', 'Türkiye\'yi Avrupa\'da temsil eden basketbol ve voleybol takımlarımız bugün Türk gecesi yaşatacak. THY Avrupa Ligi\'ndeki iki ekibimizden biri olan Anadolu Efes, saat 22.30\'da Valencia\'ya konuk olacak. Geride kalan 17 karşılaşmada 9 galibiyet ve 8 mağlubiyet alan lacivert- beyazlılar, haftaya 7. sırada girdi. Son maçında Asvel\'i 78-72 mağlup eden Anadolu Efes bir kez daha kazanmak için mücadele edecek.\r\n\r\nEurocup\'taki Bursaspor, Şampiyonlar Ligi\'nde mücadele veren Darüşşafaka ile Karşıyaka, FIBA Avrupa Kupası\'ndaki Gaziantep de sahne alacak. Kadınlar Avrupa Ligi\'ndeki F.Bahçe, Macar ekibi Szekszard\'la karşılaşacak. Eurocup\'ta G.Saray, Ormanspor ve Nesibe Aydın kritik maçlara çıkacak. Voleybolda ise CEV Şampiyonlar Ligi\'nde Ziraat Bankkart, Eczacıbaşı, F.Bahçe ve Halbank; CEV Kupası Son 16 Turu\'nda Türk Hava Yolları mücadele verecek.', 'FOTOMAÇ');
...
(11, 'Fenerbahçe ve Antalyaspor\'dan transfer zirvesi! Bünyamin Balcı ile Haji Wright', 'images/s111.jpg', 'Fenerbahçe, Süper Lig ekibi Antalyaspor\'da forma giyen Haji Wright için görüşme gerçekleştirdi.\r\n\r\nSarı lacivertliler, Wright haricinde, Bünyamin Balcı\'yı da istiyor.\r\n\r\nHaji Wright, bu sezon toplamda 18 maça çıkmış ve 11 gol 1 asist üretmişti.\r\n\r\nBünyamin Balcı ise 17 maçta 2 asist yapmıştı.', 'FOTOMAÇ', '');
...
('Melih', 'Çeltikoğlu', 'celtikoglu1616@gmail.com', 'kullanici1', '123456', 1);
...
(10, 'Voleybolda dev kapışma', 'images/s444.jpeg', 'Misli.com Sultanlar Ligi\'nde bugün dev bir maç var... Yoluna kayıpsız lider olarak devam eden Eczacıbaşı Dynavit, 19.30\'da F.Bahçe Opet\'i konuk edecek.\r\n\r\nMisli.com Sultanlar Ligi\'nde bugün dev bir maç var... Yoluna kayıpsız lider olarak devam eden Eczacıbaşı Dynavit, 19.30\'da F.Bahçe Opet\'i konuk edecek. Günün diğer maçları şöyle: 13.00: G.Saray-Kuzeyboru, Vakıfbank-Bolu, 14.00: PTTÇukurova, 15.00: Nilüfer-İlbank.', 'TRTSPOR');
...
(40, 'Melihcan', '1.voleybol haberi\r\n', 1, 'voleybol'),
(41, 'Test', 'Tebrik ederiz westbrook\'u. Başarılar..', 1, 'basketbol'),
(42, 'kullanıcı', '4.futbol haberi', 4, 'futbol'),
(43, 'Melih', 'Teşekkürler.', 1, 'basketbol');
